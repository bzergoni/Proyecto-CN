...
// var donanteprueba = new Donante("1256");
// console.log(donanteprueba);
// donanteprueba.cargar();
// setTimeout(function(){console.log(donanteprueba.show()); }, 1500);

var donanteprueba2 = new Donante("777");
// donanteprueba2.ocupacion="hacker";
// donanteprueba2.cuil_cuit="20-43654657-6";
// console.log(donanteprueba2)
// donanteprueba2.insertar();

// donanteprueba2.cargar();
// setTimeout(function(){console.log(donanteprueba2.show()); }, 1500);

// donanteprueba2.eliminar();
donanteprueba2.exist();
setTimeout(function(){if (!donanteprueba2.existe){console.log("no existe el donante");} }, 2500);
